...
const GetCatalogueRequest$json = {
  ...
  '2': [
    {'1': 'query_parameters', '3': 1, '4': 3, '5': 11, '6': '.dsp.v1alpha2.GetCatalogueRequest.QueryParametersEntry', '10': 'queryParameters'},
  ],
...
final $typed_data.Uint8List getCatalogueRequestDescriptor = $convert.base64Decode(
    ...
    'FhbHBoYTIuR2V0Q2F0YWxvZ3VlUmVxdWVzdC5RdWVyeVBhcmFtZXRlcnNFbnRyeVIPcXVlcnlQ'
...
final $typed_data.Uint8List getCatalogueResponseDescriptor = $convert.base64Decode(
    'ChRHZXRDYXRhbG9ndWVSZXNwb25zZRIxCghkYXRhc2V0cxgBIAMoCzIVLmRzcC52MWFscGhhMi'
...
const GetDatasetResponse$json = {
  ...
  '2': [
    {'1': 'dataset', '3': 1, '4': 1, '5': 11, '6': '.dsp.v1alpha2.Dataset', '10': 'dataset'},
  ],
};
...
final $typed_data.Uint8List getDatasetResponseDescriptor = $convert.base64Decode(
    'ChJHZXREYXRhc2V0UmVzcG9uc2USLwoHZGF0YXNldBgBIAEoCzIVLmRzcC52MWFscGhhMi5EYX'
    'Rhc2V0UgdkYXRhc2V0');
...
final $typed_data.Uint8List publishDatasetResponseDescriptor = $convert.base64Decode(
    ...
    'FscGhhMi5QdWJsaXNoSW5mb1ILcHVibGlzaEluZm8=');
