...
import com.dsp.v1alpha2.ProviderServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for dsp.v1alpha2.ProviderService.
 */
public object ProviderServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) dsp.v1alpha2.ProviderService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the dsp.v1alpha2.ProviderService service based on Kotlin coroutines.
   */
  public abstract class ProviderServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.Ping.
     *
    ...
    public open suspend fun ping(request: PingRequest): PingResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.Ping is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.GetCatalogue.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getCatalogue(request: GetCatalogueRequest): GetCatalogueResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.GetCatalogue is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.GetDataset.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun getDataset(request: GetDatasetRequest): GetDatasetResponse = throw
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.GetDataset is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.PublishDataset.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun publishDataset(request: PublishDatasetRequest): PublishDatasetResponse =
        throw
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.PublishDataset is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.UnpublishDataset.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun unpublishDataset(request: UnpublishDatasetRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.UnpublishDataset is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.SuspendPublishedDataset.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun suspendPublishedDataset(request: SuspendPublishedDatasetRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.SuspendPublishedDataset is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha2.ProviderService.UnsuspendPublishedDataset.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun unsuspendPublishedDataset(request: UnsuspendPublishedDatasetRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha2.ProviderService.UnsuspendPublishedDataset is unimplemented"))
