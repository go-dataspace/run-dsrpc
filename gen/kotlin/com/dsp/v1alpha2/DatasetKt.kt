...
public inline fun dataset(block: com.dsp.v1alpha2.DatasetKt.Dsl.() -> kotlin.Unit): com.dsp.v1alpha2.Dataset =
  com.dsp.v1alpha2.DatasetKt.Dsl._create(com.dsp.v1alpha2.Dataset.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `dsp.v1alpha2.Dataset`
 */
public object DatasetKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.dsp.v1alpha2.Dataset.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.dsp.v1alpha2.Dataset.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.dsp.v1alpha2.Dataset = _builder.build()
     ...
     */
     public val description: com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>
      @kotlin.jvm.JvmSynthetic
    ...
    public fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.add(value: com.dsp.v1alpha2.Multilingual) {
    ...
    public inline operator fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.plusAssign(value: com.dsp.v1alpha2.Multilingual) {
      add(value)
    }
    /**
     * `repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];`
    ...
    public fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.addAll(values: kotlin.collections.Iterable<com.dsp.v1alpha2.Multilingual>) {
    ...
    @Suppress("NOTHING_TO_INLINE")
    public inline operator fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.plusAssign(values: kotlin.collections.Iterable<com.dsp.v1alpha2.Multilingual>) {
      addAll(values)
    }
    /**
     * `repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];`
    ...
    public operator fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.set(index: kotlin.Int, value: com.dsp.v1alpha2.Multilingual) {
    ...
    public fun com.google.protobuf.kotlin.DslList<com.dsp.v1alpha2.Multilingual, DescriptionProxy>.clear() {
     ...
     */
    public var checksum: com.dsp.v1alpha2.Checksum
      @JvmName("getChecksum")
    ...
    public val DatasetKt.Dsl.checksumOrNull: com.dsp.v1alpha2.Checksum?
      get() = _builder.checksumOrNull
  }
}
@kotlin.jvm.JvmSynthetic
public inline fun com.dsp.v1alpha2.Dataset.copy(block: `com.dsp.v1alpha2`.DatasetKt.Dsl.() -> kotlin.Unit): com.dsp.v1alpha2.Dataset =
  `com.dsp.v1alpha2`.DatasetKt.Dsl._create(this.toBuilder()).apply { block() }._build()

public val com.dsp.v1alpha2.DatasetOrBuilder.issuedOrNull: com.google.protobuf.Timestamp?
  get() = if (hasIssued()) getIssued() else null

public val com.dsp.v1alpha2.DatasetOrBuilder.modifiedOrNull: com.google.protobuf.Timestamp?
  get() = if (hasModified()) getModified() else null

public val com.dsp.v1alpha2.DatasetOrBuilder.checksumOrNull: com.dsp.v1alpha2.Checksum?
