...
@kotlin.jvm.JvmName("-initializecontractRequestRequest")
public inline fun contractRequestRequest(block: com.dsp.v1alpha2.ContractRequestRequestKt.Dsl.() -> kotlin.Unit): com.dsp.v1alpha2.ContractRequestRequest =
  com.dsp.v1alpha2.ContractRequestRequestKt.Dsl._create(com.dsp.v1alpha2.ContractRequestRequest.newBuilder()).apply { block() }._build()
/**
 * ```
 ...
 * ```
 *
 * Protobuf type `dsp.v1alpha2.ContractRequestRequest`
 */
public object ContractRequestRequestKt {
  @kotlin.OptIn(com.google.protobuf.kotlin.OnlyForUseByGeneratedProtoCode::class)
  @com.google.protobuf.kotlin.ProtoDslMarker
  public class Dsl private constructor(
    private val _builder: com.dsp.v1alpha2.ContractRequestRequest.Builder
  ) {
    public companion object {
      @kotlin.jvm.JvmSynthetic
      @kotlin.PublishedApi
      internal fun _create(builder: com.dsp.v1alpha2.ContractRequestRequest.Builder): Dsl = Dsl(builder)
    }

    @kotlin.jvm.JvmSynthetic
    @kotlin.PublishedApi
    internal fun _build(): com.dsp.v1alpha2.ContractRequestRequest = _builder.build()
...
@kotlin.jvm.JvmSynthetic
public inline fun com.dsp.v1alpha2.ContractRequestRequest.copy(block: `com.dsp.v1alpha2`.ContractRequestRequestKt.Dsl.() -> kotlin.Unit): com.dsp.v1alpha2.ContractRequestRequest =
  `com.dsp.v1alpha2`.ContractRequestRequestKt.Dsl._create(this.toBuilder()).apply { block() }._build()
