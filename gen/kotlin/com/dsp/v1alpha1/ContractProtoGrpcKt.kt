...
import com.dsp.v1alpha1.ContractServiceGrpc.getServiceDescriptor
...
/**
 * Holder for Kotlin coroutine-based client and server APIs for dsp.v1alpha1.ContractService.
 */
public object ContractServiceGrpcKt {
  ...
  /**
   * A stub for issuing RPCs to a(n) dsp.v1alpha1.ContractService service as suspending coroutines.
   */
  ...
  /**
   * Skeletal implementation of the dsp.v1alpha1.ContractService service based on Kotlin coroutines.
   */
  public abstract class ContractServiceCoroutineImplBase(
    coroutineContext: CoroutineContext = EmptyCoroutineContext,
  ) : AbstractCoroutineServerImpl(coroutineContext) {
    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.Configure.
     *
    ...
    public open suspend fun configure(request: ContractServiceConfigureRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.Configure is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.RequestReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun requestReceived(request: ContractServiceRequestReceivedRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.RequestReceived is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.OfferReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun offerReceived(request: ContractServiceOfferReceivedRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.OfferReceived is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.AcceptedReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun acceptedReceived(request: ContractServiceAcceptedReceivedRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.AcceptedReceived is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.AgreementReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend fun agreementReceived(request: ContractServiceAgreementReceivedRequest):
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.AgreementReceived is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.VerificationReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.VerificationReceived is unimplemented"))

    /**
     * Returns the response to an RPC for dsp.v1alpha1.ContractService.FinalizationReceived.
     *
     * If this method fails with a [StatusException], the RPC will fail with the corresponding
     * [io.grpc.Status].  If this method fails with a [java.util.concurrent.CancellationException],
     * the RPC will fail
    ...
    public open suspend
        ...
        StatusException(UNIMPLEMENTED.withDescription("Method dsp.v1alpha1.ContractService.FinalizationReceived is unimplemented"))
