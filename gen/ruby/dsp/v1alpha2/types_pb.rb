...
module Dsp
  module V1alpha2
    Dataset = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dsp.v1alpha2.Dataset").msgclass
    PublishInfo = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dsp.v1alpha2.PublishInfo").msgclass
    Multilingual = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dsp.v1alpha2.Multilingual").msgclass
    Checksum = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dsp.v1alpha2.Checksum").msgclass
    AuthenticationType = ::Google::Protobuf::DescriptorPool.generated_pool.lookup("dsp.v1alpha2.AuthenticationType").enummodule
  end
end
