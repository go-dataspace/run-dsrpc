...
func (AuthenticationType) Descriptor() protoreflect.EnumDescriptor {
	return file_dsp_v1alpha2_types_proto_enumTypes[0].Descriptor()
}

func (AuthenticationType) Type() protoreflect.EnumType {
	return &file_dsp_v1alpha2_types_proto_enumTypes[0]
}
...
func (AuthenticationType) EnumDescriptor() ([]byte, []int) {
	return file_dsp_v1alpha2_types_proto_rawDescGZIP(), []int{0}
}
...
func (x *Dataset) Reset() {
	*x = Dataset{}
	mi := &file_dsp_v1alpha2_types_proto_msgTypes[0]
...
type PublishInfo struct {
	...
	AuthenticationType AuthenticationType     `protobuf:"varint,2,opt,name=authentication_type,json=authenticationType,proto3,enum=dsp.v1alpha2.AuthenticationType" json:"authentication_type,omitempty"`
...
func (x *PublishInfo) Reset() {
	*x = PublishInfo{}
	mi := &file_dsp_v1alpha2_types_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*PublishInfo) Descriptor() ([]byte, []int) {
	return file_dsp_v1alpha2_types_proto_rawDescGZIP(), []int{1}
}
...
func (x *Multilingual) Reset() {
	*x = Multilingual{}
	mi := &file_dsp_v1alpha2_types_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Multilingual) Descriptor() ([]byte, []int) {
	return file_dsp_v1alpha2_types_proto_rawDescGZIP(), []int{2}
}
...
func (x *Checksum) Reset() {
	*x = Checksum{}
	mi := &file_dsp_v1alpha2_types_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Checksum) Descriptor() ([]byte, []int) {
	return file_dsp_v1alpha2_types_proto_rawDescGZIP(), []int{3}
}
...
var file_dsp_v1alpha2_types_proto_rawDesc = string([]byte{
	0x0a, 0x18, 0x64, 0x73, 0x70, 0x2f, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2f, 0x74,
	...
	0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x4d, 0x75, 0x6c, 0x74, 0x69, 0x6c, 0x69, 0x6e, 0x67,
	...
	0x61, 0x32, 0x2e, 0x44, 0x61, 0x74, 0x61, 0x73, 0x65, 0x74, 0x2e, 0x4d, 0x65, 0x74, 0x61, 0x64,
	...
	0x64, 0x73, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x43, 0x68, 0x65,
	...
	0x73, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x2e, 0x41, 0x75, 0x74, 0x68,
	...
	0x73, 0x70, 0x2e, 0x76, 0x31, 0x61, 0x6c, 0x70, 0x68, 0x61, 0x32, 0x42, 0x0a, 0x54, 0x79, 0x70,
...
var (
	file_dsp_v1alpha2_types_proto_rawDescOnce sync.Once
	file_dsp_v1alpha2_types_proto_rawDescData []byte
)

func file_dsp_v1alpha2_types_proto_rawDescGZIP() []byte {
	file_dsp_v1alpha2_types_proto_rawDescOnce.Do(func() {
		file_dsp_v1alpha2_types_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dsp_v1alpha2_types_proto_rawDesc), len(file_dsp_v1alpha2_types_proto_rawDesc)))
	})
	return file_dsp_v1alpha2_types_proto_rawDescData
}

var file_dsp_v1alpha2_types_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_dsp_v1alpha2_types_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_dsp_v1alpha2_types_proto_goTypes = []any{
	(AuthenticationType)(0),       // 0: dsp.v1alpha2.AuthenticationType
	(*Dataset)(nil),               // 1: dsp.v1alpha2.Dataset
	(*PublishInfo)(nil),           // 2: dsp.v1alpha2.PublishInfo
	(*Multilingual)(nil),          // 3: dsp.v1alpha2.Multilingual
	(*Checksum)(nil),              // 4: dsp.v1alpha2.Checksum
	nil,                           // 5: dsp.v1alpha2.Dataset.MetadataEntry
	(*timestamppb.Timestamp)(nil), // 6: google.protobuf.Timestamp
}
var file_dsp_v1alpha2_types_proto_depIdxs = []int32{
	3, // 0: dsp.v1alpha2.Dataset.description:type_name -> dsp.v1alpha2.Multilingual
	6, // 1: dsp.v1alpha2.Dataset.issued:type_name -> google.protobuf.Timestamp
	6, // 2: dsp.v1alpha2.Dataset.modified:type_name -> google.protobuf.Timestamp
	5, // 3: dsp.v1alpha2.Dataset.metadata:type_name -> dsp.v1alpha2.Dataset.MetadataEntry
	4, // 4: dsp.v1alpha2.Dataset.checksum:type_name -> dsp.v1alpha2.Checksum
	0, // 5: dsp.v1alpha2.PublishInfo.authentication_type:type_name -> dsp.v1alpha2.AuthenticationType
...
func init() { file_dsp_v1alpha2_types_proto_init() }
func file_dsp_v1alpha2_types_proto_init() {
	if File_dsp_v1alpha2_types_proto != nil {
		return
	}
	file_dsp_v1alpha2_types_proto_msgTypes[0].OneofWrappers = []any{}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dsp_v1alpha2_types_proto_rawDesc), len(file_dsp_v1alpha2_types_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_dsp_v1alpha2_types_proto_goTypes,
		DependencyIndexes: file_dsp_v1alpha2_types_proto_depIdxs,
		EnumInfos:         file_dsp_v1alpha2_types_proto_enumTypes,
		MessageInfos:      file_dsp_v1alpha2_types_proto_msgTypes,
	}.Build()
	File_dsp_v1alpha2_types_proto = out.File
	file_dsp_v1alpha2_types_proto_goTypes = nil
	file_dsp_v1alpha2_types_proto_depIdxs = nil
}
