...
var file_dsp_v1alpha2_types_proto_rawDesc = []byte{
...
var (
	...
	file_dsp_v1alpha2_types_proto_rawDescData = file_dsp_v1alpha2_types_proto_rawDesc
)

func file_dsp_v1alpha2_types_proto_rawDescGZIP() []byte {
	file_dsp_v1alpha2_types_proto_rawDescOnce.Do(func() {
		file_dsp_v1alpha2_types_proto_rawDescData = protoimpl.X.CompressGZIP(file_dsp_v1alpha2_types_proto_rawDescData)
	})
...
func file_dsp_v1alpha2_types_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_dsp_v1alpha2_types_proto_rawDesc,
			NumEnums:      1,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_dsp_v1alpha2_types_proto_rawDesc = nil
