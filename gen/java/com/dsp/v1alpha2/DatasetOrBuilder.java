...
public interface DatasetOrBuilder extends
   ...
   */
  java.util.List<com.dsp.v1alpha2.Multilingual> 
      getDescriptionList();
  /**
   * <code>repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];</code>
   */
  com.dsp.v1alpha2.Multilingual getDescription(int index);
  /**
   * <code>repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];</code>
   */
   ...
   * <code>repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];</code>
   */
  java.util.List<? extends com.dsp.v1alpha2.MultilingualOrBuilder> 
      getDescriptionOrBuilderList();
  /**
   * <code>repeated .dsp.v1alpha2.Multilingual description = 4 [json_name = "description"];</code>
   */
  com.dsp.v1alpha2.MultilingualOrBuilder getDescriptionOrBuilder(
      int index);
...
java.lang.String defaultValue);
   ...
   * @return The checksum.
   */
  com.dsp.v1alpha2.Checksum getChecksum();
  /**
   * <code>optional .dsp.v1alpha2.Checksum checksum = 18 [json_name = "checksum"];</code>
   */
  com.dsp.v1alpha2.ChecksumOrBuilder getChecksumOrBuilder();
}
