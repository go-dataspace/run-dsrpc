...
// @generated from file dsp/v1alpha2/types.proto (package dsp.v1alpha2, syntax proto3)
/* eslint-disable */
// @ts-nocheck
 ...
 *
 * @generated from enum dsp.v1alpha2.AuthenticationType
 */
 ...
 *
 * @generated from message dsp.v1alpha2.Dataset
 */
export declare class Dataset extends Message<Dataset> {
  ...
  /**
   * @generated from field: repeated dsp.v1alpha2.Multilingual description = 4;
   */
  ...
  /**
   * @generated from field: optional dsp.v1alpha2.Checksum checksum = 18;
   */
  checksum?: Checksum;
  ...
  static readonly typeName = "dsp.v1alpha2.Dataset";
 ...
 *
 * @generated from message dsp.v1alpha2.PublishInfo
 */
export declare class PublishInfo extends Message<PublishInfo> {
  ...
  /**
   * @generated from field: dsp.v1alpha2.AuthenticationType authentication_type = 2;
   */
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "dsp.v1alpha2.PublishInfo";
  static readonly fields: FieldList;
 ...
 *
 * @generated from message dsp.v1alpha2.Multilingual
 */
export declare class Multilingual extends Message<Multilingual> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "dsp.v1alpha2.Multilingual";
  static readonly fields: FieldList;
 ...
 *
 * @generated from message dsp.v1alpha2.Checksum
 */
export declare class Checksum extends Message<Checksum> {
  ...
  static readonly runtime: typeof proto3;
  static readonly typeName = "dsp.v1alpha2.Checksum";
  static readonly fields: FieldList;
